...
const CustomerReview = () => {
  ...
  return (
    <section className="p-8 flex flex-col md:flex-row items-center gap-10 max-w-5xl mx-auto">
      {/* Left Section */}
      <div className="md:w-1/3 flex flex-col justify-center">
        ...
        <div className="flex justify-center md:justify-start gap-4">
          ...
          <button
            onClick={handleNext}
            className="p-3 bg-orange-500 hover:bg-orange-600 text-white rounded-full transition"
